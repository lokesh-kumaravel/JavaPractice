...
public class DiceGame {
    ...
    public static void main(String[] args) {
        ...
        // Since we know that D1 has an advantage over D2, we find the lowest score for
        // D3
        // when D3 has an advantage over D1 but a lower score against D2, and vice
        // versa.
        double lowestScore = 1.0;
        double highestScore = 0.0;

        // We have to find a third die (D3). In this simplified case, we assume we are
        // trying to
        // find reasonable scores based on these two dice. Thus, we perform some
        // boundary checks.
